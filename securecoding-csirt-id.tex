...
%\setbeamertemplate{footline}{A Sample Talk}
...
\date{30 Mei 2012}
%\institute{Chapter Leader OWASP Indonesia}
...
\begin{frame}
	...
	%	\begin{column}{0.5\textwidth}
			...
			\end{description}
 	%	\end{column}
 	%	\begin{column}{0.5\texwidth}
 			\begin{flushleft}
				\includegraphics[height=3cm]{/home/za/Gambar/za-beijing.jpeg}
			\end{flushleft}
 	%	\end{column}
	%\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}		
		\column{0.4\textwidth}
        \includegraphics[height=4cm]{/home/za/Dokumen/owasp/id/itb/google-perspective.png} \pause
        \column{0.6\textwidth}
		\vskip4cm 
		\includegraphics[height=2cm]{/home/za/Dokumen/owasp/id/itb/network.png} \pause		
	\end{columns}
	\vskip.5cm
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{.6\textwidth}
	\begin{center}
\includegraphics[scale=.75]{/home/za/Dokumen/owasp/OWASP_Image_Toolbox/owasp_3Wx300dpi.jpg}	
\end{center}	
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{.4\textwidth}
			\begin{center}
				\includegraphics[height=3cm]{/home/za/Gambar/owasp_logo.jpg}
			\end{center}
		\end{columns}
\end{frame}
...
\begin{frame}
	\begin{columns}
		...
		\column{.6\textwidth}
			\begin{center}
				\includegraphics[height=4cm]{/home/za/Gambar/wikipedia.jpg}
			\end{center}	
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=5cm]{/home/za/Gambar/owasp-summit.jpg}
		\\ 
		\vskip.5cm
...
\begin{frame}
	\frametitle{Chapter}
	\begin{center}
		\includegraphics[height=5cm]{/home/za/Gambar/owaspid.jpg} 
		\vskip.5cm		
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[height=5cm]{/home/za/Gambar/owaspid-site.jpg}			
	\end{center}
	\begin{description}
...
\begin{frame}
	...
	\begin{columns}			
		\column{.3\textwidth}
			\includegraphics[height=4cm]{/home/za/Gambar/owaspid-topten.jpg}
			\\ \begin{center}
					Top 10 - 2010
				\end{center} 		
		\column{.3\textwidth}
			\includegraphics[height=4cm]{/home/za/Gambar/owaspid-asvs.jpg}
			\\ \begin{center}
					ASVS
				\end{center}
	\end{columns}
...
\begin{frame}
	...
	%	\column{.5\textwidth}
	%	\column{.5\textwidth}
			\includegraphics[height=5cm]{/home/za/Gambar/securitythroughlifecycle.jpg}
			\\
			\vskip.5cm
...
\begin{frame}[fragile]
	...
	%\begin{verbatim}
		%\begin{lstlisting}
			\lstinputlisting{/home/za/Dokumen/csirt/sqli-low.php}
		%\end{lstlisting}
	%\end{verbatim}	
	\begin{center}
...
\begin{frame}[fragile]
	...
	%\begin{verbatim}
		%\begin{lstlisting}
			\lstinputlisting{/home/za/Dokumen/csirt/login.php}
		%\end{lstlisting}
	%\end{verbatim}	
	\begin{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[height=5cm]{/home/za/Gambar/IMG_2825.JPG}
